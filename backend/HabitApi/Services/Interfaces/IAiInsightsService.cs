...
public interface IAiInsightsService
{
    ...
    Task<AiInsightResultDto> BuildDailyInsightAsync(DailySummaryDto summary, CancellationToken cancellationToken);
    ...
    Task<AiInsightResultDto> BuildHabitSupportMessageAsync(string habitName, string scenario, CancellationToken cancellationToken);
    ...
    Task<AiInsightResultDto> BuildCitySummaryAsync(string city, List<CityHabitStatDto> stats, CancellationToken cancellationToken);
}
